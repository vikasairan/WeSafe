                ...
                auth.createUserWithEmailAndPassword(email, password)
                        .addOnCompleteListener(SignupActivity.this, new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                ...
                                Toast.makeText(SignupActivity.this, "Verfication Email Sent", Toast.LENGTH_SHORT).show();
                                    ...
                                    myRef.child(auth.getCurrentUser().getUid()).child("phone").setValue(phone);
                                    myRef.child(auth.getCurrentUser().getUid()).child("name").setValue(name);
